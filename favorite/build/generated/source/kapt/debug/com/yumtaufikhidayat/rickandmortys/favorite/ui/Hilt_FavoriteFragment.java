...
public abstract class Hilt_FavoriteFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavoriteFragment() {
    super();
  }

  Hilt_FavoriteFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavoriteFragment_GeneratedInjector) this.generatedComponent()).injectFavoriteFragment(UnsafeCasts.<FavoriteFragment>unsafeCast(this));
    }
  }
